...
class Home extends Component {
    ...
    componentDidMount() {
        ...
        axios.get("https://vschool-cors.herokuapp.com?url=http://quotesondesign.com/wp-json/posts?filter[orderby]=rand&filter[posts_per_page]=40").then((response) =>{
            ...
            <div>
                <div className="dropdown">
                    ...
                    <div className="dropdown-content">
                        ...
                        <a href="" onClick='this.state.allQuotes[0]'>Random Quote</a>
