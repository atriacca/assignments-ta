...
axios.put("https://api.vschool.io/alan/todo/"+todo._id, {
    // description: e.target.value,
...
function createTodoEditForm(e, todo){
    ...
    const newImgUrl = document.createElement('input')
    ...
    newImgUrl.name = "newImgUrl"

    saveBtn.textContent = "SAVE"
    saveBtn.addEventListener("click", function(e){
        console.log(saveBtn.title.value)
        const updatedTitle = saveBtn.title.value
        const newTodo = {
