        ...
        <div>
            ...
            <div>
                ...
                <div className="project">
                    ...
                    Built with JavaScript, React, Node.js, Axios, HTML, and CSS</h6><a href="http://atriacca-devquotes.surge.sh/" target="_blank" rel="noopener noreferrer"><img src={require('./resources/DevQuotes-no-border-2.png')} alt="Unable to render"/></a>
                </div>
                <div className="project">
