    ...
    return (
        <div>
            ...
            <div>
                ...
                <div className="projectPhone">
                    <a href="http://atriacca-devquotes.surge.sh/" target="_blank" rel="noopener noreferrer"><img src={require('./resources/DevQuotes-no-border.png')} alt="Unable to render"/></a>
